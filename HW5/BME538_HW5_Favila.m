...
%BME 538 HW 5
%15 Apr 2019
%[Code modified from 'ExampleCode_HW5.m' - Dr. Arfanakis]
clc;
clear all;
close all;
...
%prepare 5 sets of 3D Array: original, time corrected,trilinear, 4th degree
%b-spline, and nearest neigbor
%uses volume 011
...
%---------------------------------------------------
%Show Sagital View
figure('NumberTitle','off','Name','Different Reslice Options Sagittal View')
subplot(2,3,1)
Ny_slice = 30;
org_image=zeros(N_x,N_slice);
org_image_f=zeros(N_x,N_slice);
...
title('Pixel Variation from original to 4th Degree interpolation')
%---------------------
%Show difference of given interpolation methods and original (Axial View)
figure('NumberTitle','off','Name','Comparison of different interpolation methods (Axial View)')
slice_no = 3;
